            ...
            <Container className={styles.OrderHistoryContainer}>
                <Card className={styles.OrderHistoryCard}>
                    <Card.Body>
                        ...
                        <Card.Text><h4 className={styles.Subtitle}>Дата:</h4><p className={styles.DescriptionText}>30.01.2023</p></Card.Text>
                        <Card.Text><h4 className={styles.Subtitle}>Заказчик: </h4><p className={styles.DescriptionText}>Иванов П. И. </p></Card.Text>
                        <Card.Text><h4 className={styles.Subtitle}>Ребенок: </h4><p className={styles.DescriptionText}>Иванов И. П. 10 “А” класс</p></Card.Text>
